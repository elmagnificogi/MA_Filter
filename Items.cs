...
namespace MapAssist.Types
{
    public static class Items
    {
        ...
        public static readonly Dictionary<Item, string> ItemClassesToChinese = new Dictionary<Item, string>()
        {
            ...
            [Item.ClassWands] = "·¨ÕÈ",
            [Item.ClassClubs] = "¶Ì°ô",
            [Item.ClassScepters] = "È¨ÕÈ",
            [Item.ClassMaces] = "¶¤´¸",
            [Item.ClassHammers] = "´ó´¸",
            [Item.ClassSwords] = "½£",
            [Item.ClassDaggers] = "Ø°Ê×",
            [Item.ClassThrowingKnifes] = "·Éµ¶",
            [Item.ClassThrowingAxes] = "·É¸«",
            [Item.ClassJavelins] = "±êÇ¹",
            [Item.ClassSpears] = "³¤Ã¬",
            [Item.ClassPolearms] = "³¤±ú",
            [Item.ClassStaves] = "³¤ÕÈ",
            [Item.ClassBows] = "¹­",
            [Item.ClassCrossbows] = "Ê®×Öåó",

            [Item.ClassHelms] = "Í·¿ø",
            [Item.ClassArmors] = "¿ø¼×",
            [Item.ClassShields] = "¶ÜÅÆ",
            [Item.ClassGloves] = "ÊÖÌ×",
            [Item.ClassBoots] = "Ñ¥×Ó",
            [Item.ClassBelts] = "Ñü´ø",
            [Item.ClassCirclets] = "Í·»·",

            [Item.ClassAssassinKatars] = "´Ì¿Í×¦",
            [Item.ClassSorceressOrbs] = "·¨Ê¦·¨ÕÈ",
            [Item.ClassAmazonBows] = "ÑÇÂíÑ·¹­",
            [Item.ClassAmazonSpears] = "ÑÇÂíÑ·Ã¬",
            [Item.ClassAmazonJavelins] = "ÑÇÂíÑ·±êÇ¹",
            [Item.ClassDruidHelms] = "µÂÂ³ÒÁÍ·¿ø",
            [Item.ClassBarbarianHelms] = "Ò°ÂùÈËÍ·¿ø",
            [Item.ClassPaladinShields] = "ÆïÊ¿¶ÜÅÆ",
            [Item.ClassNecromancerShields] = "ËÀÁé¶ÜÅÆ",

            [Item.ClassRings] = "½äÖ¸",
            [Item.ClassAmulets] = "ÏîÁ´",
            [Item.ClassRunes] = "·ûÎÄ",
            [Item.ClassGems] = "±¦Ê¯/Öé±¦",
            [Item.ClassCharms] = "Éñ·û",
            [Item.ClassEssences] = "¾«»ª",
            [Item.ClassKeys] = "Ô¿³×",
            [Item.ClassPotions] = "Ò©Ë®",
