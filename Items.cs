...
namespace MapAssist.Types
{
    public static class Items
    {
        ...
        public static readonly Dictionary<Item, string> ItemClassesToChinese = new Dictionary<Item, string>()
        {
            ...
            [Item.ClassWands] = "法杖",
            [Item.ClassClubs] = "短棒",
            [Item.ClassScepters] = "权杖",
            [Item.ClassMaces] = "钉锤",
            [Item.ClassHammers] = "大锤",
            [Item.ClassSwords] = "剑",
            [Item.ClassDaggers] = "匕首",
            [Item.ClassThrowingKnifes] = "飞刀",
            [Item.ClassThrowingAxes] = "飞斧",
            [Item.ClassJavelins] = "标枪",
            [Item.ClassSpears] = "长矛",
            [Item.ClassPolearms] = "长柄",
            [Item.ClassStaves] = "长杖",
            [Item.ClassBows] = "弓",
            [Item.ClassCrossbows] = "十字弩",

            [Item.ClassHelms] = "头盔",
            [Item.ClassArmors] = "盔甲",
            [Item.ClassShields] = "盾牌",
            [Item.ClassGloves] = "手套",
            [Item.ClassBoots] = "靴子",
            [Item.ClassBelts] = "腰带",
            ...
            [Item.ClassAmazonBows] = "亚马逊弓",
            [Item.ClassAmazonSpears] = "亚马逊矛",
            [Item.ClassAmazonJavelins] = "亚马逊标枪",
            [Item.ClassDruidHelms] = "德鲁伊头盔",
